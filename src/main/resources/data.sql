...
values(50, 'Konf1', 'Desc1', true, 10, 10, 5, 1, 'CONFERENCE', '2018-08-12', '2018-08-13', 'UPCOMING', 1);
...
insert into prelection(id, name, description, status, user_id, event_id)
	values (1, 'Prelekcja 1', 'Bardzo fajna prelekcja na ciekawy temat', 1, 101, 11);
insert into prelection(id, name, description, status, user_id, event_id)
	values (2, 'Prelekcja 2', 'Bardzo fajna prelekcja na ciekawszy temat', 1, 102, 21);
insert into prelection(id, name, description, status, user_id, event_id)
	values (3, 'Prelekcja 3', 'Bardzo fajna prelekcja na ciekawy temat', 1, 103, 11);